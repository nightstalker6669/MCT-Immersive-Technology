...
public class ITBaseItem extends Item {
    ...
    public boolean canEquip(ItemStack stack, EquipmentSlot armorType, Entity entity) {
        EquipmentSlot preferred = entity instanceof LivingEntity living ? living.getEquipmentSlotForItem(stack) : getEquipmentSlot(stack);
        return preferred == armorType || getEquipmentSlot(stack) == armorType;
    }
