...
public class ITLootFunctions {
    ...
    private static RegistryObject<LootPoolEntryType> registerEntry(String id, Supplier<MapCodec<? extends LootPoolEntryContainer>> codec) { return ENTRY_REGISTER.register(id, () -> new LootPoolEntryType(codec.get())); }
