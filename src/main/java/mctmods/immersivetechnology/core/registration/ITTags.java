...
public class ITTags {
    ...
    public static final TagKey<Fluid> fluidDistilledWaterForge = FluidTags.create(commonLoc("distilled_water"));
    ...
    public static final TagKey<Fluid> fluidSteamForge = FluidTags.create(commonLoc("steam"));

    public static final TagKey<Item> salt = ItemTags.create(modLoc("salt"));
    public static final TagKey<Item> saltForge = ItemTags.create(commonLoc("dusts/salt"));
    ...
    private static ResourceLocation commonLoc(String path) { return ResourceLocation.fromNamespaceAndPath("c", path); }
